			...
			<div class="sc-cmthru iKdPpP">
				<div class="sc-kGXeez kXiRmv">
					<ul class="sc-jKJlTe jxbiXh">
						...
						<li class="sc-eNQAEJ gPmVSj">Español</li>
						<li class="sc-eNQAEJ gPmVSj">Español (Latinoamérica)</li>
						<li class="sc-eNQAEJ gPmVSj">Français</li>
						<li class="sc-eNQAEJ gPmVSj">Português</li>
						<li class="sc-eNQAEJ gPmVSj">Türkçe</li>
						<li class="sc-eNQAEJ gPmVSj">Русский</li>
					</ul>
